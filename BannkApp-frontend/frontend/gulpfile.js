// generated on 2020-06-03 using generator-webapp 4.0.0-8
...
let serve;
if (isDev) {
  serve = series(clean, parallel(styles, scripts, fonts, data), startAppServer);
} else if (isTest) {
  serve = series(clean, scripts, data, startTestServer);
} else if (isProd) {
