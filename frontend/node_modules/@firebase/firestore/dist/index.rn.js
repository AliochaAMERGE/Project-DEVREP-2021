...
class tt {
    ...
    start(t, e) {
        this.o = n => {
            t.enqueueRetryable((() => (t => (null != t.error && F("FirebaseAppCheckTokenProvider", `Error getting App Check token; using placeholder token instead. Error: ${t.error.message}`), 
            e(t.token)))(n)));
        };
        const n = t => {
 ...
 */ class Ct {
    ...
    static fromPath(t) {
        return new Ct(wt.fromString(t));
    }
    static fromName(t) {
        return new Ct(wt.fromString(t).popFirst(5));
    }
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function kt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return ot(t.arrayValue.values || [], e.arrayValue.values || [], kt);
...
function $t(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = rt(At(t.latitude), At(e.latitude));
            if (0 !== n) return n;
            return rt(At(t.longitude), At(e.longitude));
...
function Ft(t, e) {
    ...
    const n = It(t), s = It(e), i = rt(n.seconds, s.seconds);
...
/** Returns true if `value` is an IntegerValue . */ function Bt(t) {
...
/** Creates a deep copy of `source`. */ function Qt(t) {
    ...
    if (t.mapValue) {
        ...
        return lt(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = Qt(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
 ...
 */ class zt {
     ...
     */    static newInvalidDocument(t) {
        return new zt(t, 0 /* INVALID */ , ut.min(), Wt.empty(), 0 /* SYNCED */);
    }
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new zt(t, 2 /* NO_DOCUMENT */ , e, Wt.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, e) {
        return new zt(t, 3 /* UNKNOWN_DOCUMENT */ , e, Wt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
     ...
     */    convertToNoDocument(t) {
        return this.version = t, this.documentType = 2 /* NO_DOCUMENT */ , this.data = Wt.empty(), 
        this.documentState = 0 /* SYNCED */ , this;
    }
    /**
     ...
     */    convertToUnknownDocument(t) {
        return this.version = t, this.documentType = 3 /* UNKNOWN_DOCUMENT */ , this.data = Wt.empty(), 
...
function Yt(t) {
    ...
    if (null === e.R) {
        ...
        null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup), t += "|f:", t += e.filters.map((t => ne(t))).join(","), 
        t += "|ob:", t += e.orderBy.map((t => function(t) {
            // TODO(b/29183165): Make this collision robust.
            return t.field.canonicalString() + t.dir;
        }(t))).join(","), Vt(e.limit) || (t += "|l:", t += e.limit), e.startAt && (t += "|lb:", 
        t += fe(e.startAt)), e.endAt && (t += "|ub:", t += fe(e.endAt)), e.R = t;
    }
    return e.R;
}
...
function Xt(t) {
    ...
    Vt(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += `, orderBy: [${t.orderBy.map((t => function(t) {
        return `${t.field.canonicalString()} (${t.dir})`;
    }(t))).join(", ")}]`), t.startAt && (e += ", startAt: " + fe(t.startAt)), t.endAt && (e += ", endAt: " + fe(t.endAt)), 
    `Target(${e})`;
}
...
class ee extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.P(t, e, n) : new se(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new ce(t, n) : "in" /* IN */ === e ? new ae(t, n) : "not-in" /* NOT_IN */ === e ? new ue(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new he(t, n) : new ee(t, e, n);
    }
    static P(t, e, n) {
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.v($t(e, this.value)) : null !== e && Nt(this.value) === Nt(e) && this.v($t(e, this.value));
...
/** Filter that matches on key fields within an array. */ class ie extends ee {
    constructor(t, e) {
        super(t, "in" /* IN */ , e), this.keys = oe("in" /* IN */ , e);
    }
    matches(t) {
...
/** Filter that matches on key fields not present within an array. */ class re extends ee {
    constructor(t, e) {
        super(t, "not-in" /* NOT_IN */ , e), this.keys = oe("not-in" /* NOT_IN */ , e);
    }
    matches(t) {
        return !this.keys.some((e => e.isEqual(t.key)));
    }
...
/** A Filter that implements the array-contains operator. */ class ce extends ee {
    constructor(t, e) {
        super(t, "array-contains" /* ARRAY_CONTAINS */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return Ut(e) && xt(e.arrayValue, this.value);
    }
}

/** A Filter that implements the IN operator. */ class ae extends ee {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
...
/** A Filter that implements the not-in operator. */ class ue extends ee {
    constructor(t, e) {
...
/** A Filter that implements the array-contains-any operator. */ class he extends ee {
    constructor(t, e) {
        super(t, "array-contains-any" /* ARRAY_CONTAINS_ANY */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return !(!Ut(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => xt(this.value.arrayValue, t)));
    }
}
...
/** Creates a new Query instance with the options provided. */ function ye(t, e, n, s, i, r, o, c) {
    return new ge(t, e, n, s, i, r, o, c);
}
 ...
 */ function Pe(t) {
    ...
    if (null === e.S) {
        ...
        t.isKeyField() || e.S.push(new de(t)), e.S.push(new de(mt.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function be(t) {
    ...
    if (!e.D) if ("F" /* First */ === e.limitType) e.D = Jt(e.path, e.collectionGroup, Pe(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new le(e.endAt.position, !e.endAt.before) : null, s = e.startAt ? new le(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
        e.D = Jt(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.D;
}
 ...
 */ function Me(t, e, n) {
    ...
    }(n, e) : t instanceof qe ? Ke(t, e) : t instanceof je ? Qe(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = Be(t, e), s = Ge(n) + Ge(t.N);
        return Bt(n) && Bt(t.N) ? $e(s) : xe(t.k, s);
    }(t, e);
}
 ...
 */ function Le(t, e, n) {
    ...
    // applications.
    return t instanceof qe ? Ke(t, e) : t instanceof je ? Qe(t, e) : n;
}
 ...
 */ function Be(t, e) {
    return t instanceof We ? Bt(n = e) || function(t) {
...
/** Transforms an array value via a union operation. */ class qe extends Oe {
    constructor(t) {
...
function Je(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof qe && e instanceof qe || t instanceof je && e instanceof je ? ot(t.elements, e.elements, kt) : t instanceof We && e instanceof We ? kt(t.N, e.N) : t instanceof Ue && e instanceof Ue;
 ...
 */ function en(t, e, n) {
    t instanceof cn ? function(t, e, n) {
        ...
        i.setAll(un(t)), i.setAll(s), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function nn(t, e, n) {
    t instanceof cn ? function(t, e, n) {
        ...
        return;
        const s = t.value.clone(), i = ln(t.fieldTransforms, n, e);
        s.setAll(i), e.convertToFoundDocument(on(e), s).setHasLocalMutations();
    }
    /**
 ...
 */ function sn(t, e) {
    ...
    for (const s of t.fieldTransforms) {
        const t = e.data.field(s.field), i = Be(s.transform, t || null);
        null != i && (null == n && (n = Wt.empty()), n.set(s.field, i));
    }
    return n || null;
}
...
function rn(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && ot(t, e, ((t, e) => Je(t, e)));
...
function yn(t) {
    ...
    return O("GRPC error has no .code"), j.UNKNOWN;
    switch (t) {
      case _n.OK:
        return j.OK;
      ...
      case _n.UNAUTHENTICATED:
        return j.UNAUTHENTICATED;

      case _n.INVALID_ARGUMENT:
        return j.INVALID_ARGUMENT;

      case _n.NOT_FOUND:
        return j.NOT_FOUND;

      case _n.ALREADY_EXISTS:
        return j.ALREADY_EXISTS;

      case _n.PERMISSION_DENIED:
        return j.PERMISSION_DENIED;

      case _n.FAILED_PRECONDITION:
        return j.FAILED_PRECONDITION;

      case _n.ABORTED:
        return j.ABORTED;

      case _n.OUT_OF_RANGE:
        return j.OUT_OF_RANGE;

      case _n.UNIMPLEMENTED:
 ...
 *     Code.UNKNOWN.
 */ (mn = _n || (_n = {}))[mn.OK = 0] = "OK", mn[mn.CANCELLED = 1] = "CANCELLED", 
...
class pn {
    ...
    insert(t, e) {
        return new pn(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, En.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new pn(this.comparator, this.root.remove(t, this.comparator).copy(null, null, En.BLACK, null, null));
    }
    ...
    getIterator() {
        return new Tn(this.root, null, this.comparator, !1);
    }
    getIteratorFrom(t) {
        return new Tn(this.root, t, this.comparator, !1);
    }
    getReverseIterator() {
        return new Tn(this.root, null, this.comparator, !0);
    }
    getReverseIteratorFrom(t) {
        return new Tn(this.root, t, this.comparator, !0);
    }
}
...
class En {
    constructor(t, e, n, s, i) {
        this.key = t, this.value = e, this.color = null != n ? n : En.RED, this.left = null != s ? s : En.EMPTY, 
        this.right = null != i ? i : En.EMPTY, this.size = this.left.size + 1 + this.right.size;
    }
    // Returns a copy of the current node, optionally replacing pieces of it.
    copy(t, e, n, s, i) {
        return new En(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
    }
    isEmpty() {
        return !1;
    }
    ...
    remove(t, e) {
        ...
        s = s.copy(null, null, null, s.left.remove(t, e), null); else {
            ...
            0 === e(t, s.key)) {
                if (s.right.isEmpty()) return En.EMPTY;
...
class In {
    constructor(t) {
        this.comparator = t, this.data = new pn(this.comparator);
    }
    has(t) {
    ...
    getIteratorFrom(t) {
        return new An(this.data.getIteratorFrom(t));
    }
 ...
 */ class $n {
     ...
     */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
        return new $n(Tt.EMPTY_BYTE_STRING, e, Cn(), Cn(), Cn());
    }
}
...
class Bn {
     ...
     */    dt(t) {
        ...
        if (s) {
            ...
            if (te(t)) if (0 === n) {
                ...
                this.at(e, n, zt.newNoDocument(n, ut.min()));
            } else U(1 === n); else {
                this._t(e) !== n && (
        ...
        this.nt.forEach(((n, s) => {
            ...
            if (i) {
                if (n.current && te(i.target)) {
                    ...
                    null !== this.st.get(e) || this.yt(s, e) || this.at(s, e, zt.newNoDocument(e, t));
                }
                n.j && (e.set(s, n.G()), n.H());
            }
        }));
    ...
    ht(t) {
        let e = this.nt.get(t);
        return e || (e = new Ln, this.nt.set(t, e)), e;
    }
    Tt(t) {
        let e = this.it.get(t);
        return e || (e = new In(rt), this.it = this.it.insert(t, e)), e;
    }
    /**
...
function es(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? wt.emptyPath() : ss(e);
}
...
/** Creates a Document proto from key and fields (but no create/update time) */ function is(t, e, n) {
    return {
        name: Xn(t, e),
...
function rs(t, e, n) {
    const s = Zn(t, e.name), i = Hn(e.updateTime), r = new Wt({
        mapValue: {
            fields: e.fields
        }
    }), o = zt.newFoundDocument(s, i, r);
...
function os(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Zn(t, e.found.name), s = Hn(e.found.updateTime), i = new Wt({
            mapValue: {
                fields: e.found.fields
            }
        });
        return zt.newFoundDocument(n, s, i);
    }(t, e) : "missing" in e ? function(t, e) {
        U(!!e.missing), U(!!e.readTime);
        const n = Zn(t, e.missing), s = Hn(e.readTime);
        return zt.newNoDocument(n, s);
    }(t, e) : B();
}
 ...
 */ (o);
        ...
        const i = Zn(t, s.document.name), r = Hn(s.document.updateTime), o = new Wt({
            mapValue: {
                fields: s.document.fields
            }
        }), c = zt.newFoundDocument(i, r, o), a = s.targetIds || [], u = s.removedTargetIds || [];
        n = new Fn(a, u, c.key, c);
    } else if ("documentDelete" in e) {
        e.documentDelete;
        const s = e.documentDelete;
        s.document;
        const i = Zn(t, s.document), r = s.readTime ? Hn(s.readTime) : ut.min(), o = zt.newNoDocument(i, r), c = s.removedTargetIds || [];
        n = new Fn([], c, o.key, o);
        ...
        if (!("filter" in e)) return B();
        {
            ...
            const t = e.filter;
            t.targetId;
            const s = t.count || 0, i = new wn(s), r = t.targetId;
            n = new On(r, i);
        }
    }
    return n;
...
function us(t, e) {
    ...
    }(e.currentDocument) : Xe.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) U("REQUEST_TIME" === e.setToServerValue), n = new Ue; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new qe(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new je(t);
        } else "increment" in e ? n = new We(t, e.increment) : B();
        const s = mt.fromServerFormat(e.fieldPath);
        return new He(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        const i = Zn(t, e.update.name), r = new Wt({
            mapValue: {
...
function hs(t, e) {
    return t && t.length > 0 ? (U(void 0 !== e), t.map((t => function(t, e) {
        ...
        let n = t.updateTime ? Hn(t.updateTime) : Hn(e);
        ...
        n = Hn(e)), new Ye(n, t.transformResults || []);
    }(t, e)))) : [];
}
 ...
 */ (t, e.limit);
    return null !== o && (n.structuredQuery.limit = o), e.startAt && (n.structuredQuery.startAt = ms(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = ms(e.endAt)), n;
}
...
function ds(t) {
    ...
    let r = [];
    n.where && (r = _s(n.where));
    let o = [];
    n.orderBy && (o = n.orderBy.map((t => function(t) {
        return new de(Es(t.field), 
        // visible for testing
        function(t) {
            switch (t) {
              case "ASCENDING":
    ...
    let a = null;
    n.startAt && (a = gs(n.startAt));
    let u = null;
    return n.endAt && (u = gs(n.endAt)), ye(e, i, o, r, c, "F" /* First */ , a, u);
}
...
function _s(t) {
    return t ? void 0 !== t.unaryFilter ? [ As(t) ] : void 0 !== t.fieldFilter ? [ Is(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => _s(t))).reduce(((t, e) => t.concat(e))) : B() : [];
}
...
function Is(t) {
    return ee.create(Es(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function As(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        ...
        return ee.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        const n = Es(t.unaryFilter.field);
        return ee.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        const s = Es(t.unaryFilter.field);
        return ee.create(s, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        const i = Es(t.unaryFilter.field);
        return ee.create(i, "!=" /* NOT_EQUAL */ , {
            nullValue: "NULL_VALUE"
        });
...
/** Encodes a single segment of a resource path into the given result */ function vs(t, e) {
    let n = e;
    const s = t.length;
    for (let e = 0; e < s; e++) {
        const s = t.charAt(e);
...
/** Name of the IndexedDb object store.  */ Bs.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
Bs.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
Bs.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
Bs.documentTargetsKeyPath = [ "path", "targetId" ];
 ...
 */ Us.key = "targetGlobalKey", Us.store = "targetGlobal";
...
/** Name of the IndexedDb object store. */ qs.store = "collectionParents", 
...
/** Name of the IndexedDb object store. */ Ks.store = "clientMetadata", 
...
// Visible for testing
const Ws = [ ...[ ...[ ...[ ...[ Ns.store, ks.store, xs.store, Os.store, Ls.store, Cs.store, Us.store, Bs.store ], Ks.store ], Ms.store ], qs.store ], js.store, Qs.store ], Gs = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
 ...
 */ class Hs {
    ...
    next(t, e) {
        return this.callbackAttached && B(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new Hs(((n, s) => {
            this.nextCallback = e => {
    ...
    wrapSuccess(t, e) {
        return t ? this.wrapUserFunction((() => t(e))) : Hs.resolve(e);
    }
    wrapFailure(t, e) {
        return t ? this.wrapUserFunction((() => t(e))) : Hs.reject(e);
    }
    static resolve(t) {
        return new Hs(((e, n) => {
            e(t);
...
class Js {
    constructor(t, e) {
        ...
        this.It = new W, this.transaction.oncomplete = () => {
            ...
            e.error ? this.It.reject(new Zs(t, e.error)) : this.It.resolve();
        }, this.transaction.onerror = e => {
            const n = ii(e.target.error);
            this.It.reject(new Zs(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
    ...
    abort(t) {
        t && this.It.reject(t), this.aborted || (F("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
     ...
     */    async Ct(t) {
        return this.db || (F("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new Q(j.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === s.name ? n(new Q(j.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s)) : n(new Zs(t, s));
            }, s.onupgradeneeded = t => {
    ...
    async runTransaction(t, e, n, s) {
        ...
        for (;;) {
            ...
            try {
                ...
                e.abort(t), Hs.reject(t)))).toPromise();
 ...
 */ class Xs {
     ...
     */    delete() {
        return ni(this.$t.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Zs extends Q {
    constructor(t, e) {
        super(j.UNAVAILABLE, `IndexedDB transaction '${t}' failed: ${e}`), this.name = "IndexedDbTransactionError";
    }
}

/** Verifies whether `e` is an IndexedDbTransactionError. */ function ti(t) {
 ...
 */ class ci {
     ...
     */    applyToLocalView(t) {
        ...
        for (const e of this.baseMutations) e.key.isEqual(t.key) && nn(e, t, this.localWriteTime);
        // Second, apply all user-provided mutations.
                for (const e of this.mutations) e.key.isEqual(t.key) && nn(e, t, this.localWriteTime);
    }
    /**
 ...
 */ class ui {
    ...
    /** Creates a new target data instance with an updated sequence number. */    withSequenceNumber(t) {
        return new ui(this.target, this.targetId, this.purpose, t, this.snapshotVersion, this.lastLimboFreeSnapshotVersion, this.resumeToken);
    }
    /**
     * Creates a new target data instance with an updated resume token and
     * snapshot version.
     */    withResumeToken(t, e) {
        return new ui(this.target, this.targetId, this.purpose, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t);
    }
    /**
     * Creates a new target data instance with an updated last limbo free
     * snapshot version number.
     */    withLastLimboFreeSnapshotVersion(t) {
        return new ui(this.target, this.targetId, this.purpose, this.sequenceNumber, this.snapshotVersion, t, this.resumeToken);
    }
}
...
/** Decodes a remote document from storage locally to a Document. */ function li(t, e) {
    if (e.document) return rs(t.Gt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        const t = Ct.fromSegments(e.noDocument.path), n = mi(e.noDocument.readTime), s = zt.newNoDocument(t, n);
        return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
    }
    if (e.unknownDocument) {
        const t = Ct.fromSegments(e.unknownDocument.path), n = mi(e.unknownDocument.version);
        return zt.newUnknownDocument(t, n);
    }
    return B();
}

/** Encodes a document for storage locally. */ function fi(t, e, n) {
    const s = di(n), i = e.key.path.popLast().toArray();
    if (e.isFoundDocument()) {
        const n = function(t, e) {
            return {
                name: Xn(t, e.key),
                fields: e.data.value.mapValue.fields,
                updateTime: Wn(t, e.version.toTimestamp())
            };
    ...
    if (e.isNoDocument()) {
        const t = e.key.path.toArray(), n = _i(e.version), r = e.hasCommittedMutations;
        return new Os(
        /* unknownDocument= */ null, new $s(t, n), 
        /* document= */ null, r, s, i);
    }
    if (e.isUnknownDocument()) {
        const t = e.key.path.toArray(), n = _i(e.version);
        return new Os(new Fs(t, n), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function gi(t, e) {
    const n = (e.baseMutations || []).map((e => us(t.Gt, e)));
    ...
    const s = e.mutations.map((e => us(t.Gt, e))), i = at.fromMillis(e.localWriteTimeMs);
    return new ci(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function yi(t) {
    const e = mi(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? mi(t.lastLimboFreeSnapshotVersion) : ut.min();
    let s;
    var i;
...
/** Encodes TargetData into a DbTarget for storage locally. */ function pi(t, e) {
    const n = _i(e.snapshotVersion), s = _i(e.lastLimboFreeSnapshotVersion);
    let i;
    i = te(e.target) ? ls(t.Gt, e.target) : fs(t.Gt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Ls(e.targetId, Yt(e.target), n, r, e.sequenceNumber, s, i);
}
 ...
 */ function Ii(t) {
    return oi(t, js.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function Ai(t) {
    return oi(t, Qs.store);
}
 ...
 */ class Ri {
    ...
    getCollectionParents(t, e) {
        return Hs.resolve(this.zt.getEntries(e));
    }
}
 ...
 */ class Pi {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new In(wt.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new In(wt.comparator)).toArray();
    }
}
...
function Di(t, e, n) {
    ...
    for (const t of n.mutations) {
        const s = xs.key(e, t.key.path, n.batchId);
        r.push(i.delete(s)), u.push(t.key);
    }
    return Hs.waitFor(r).next((() => u));
}
...
class Ni {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            U("number" == typeof o);
            const c = new ci(o, e, n, s), a = function(t, e, n) {
            ...
            for (const t of s) {
                ...
                h = h.add(t.key.path.popLast()), u.push(r.put(a)), u.push(i.put(e, xs.PLACEHOLDER));
            }
            return h.forEach((e => {
    ...
    lookupMutationBatch(t, e) {
        return xi(t).get(e).next((t => t ? (U(t.userId === this.userId), gi(this.k, t)) : null));
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Zt(t, e) {
        return this.Yt[e] ? Hs.resolve(this.Yt[e]) : this.lookupMutationBatch(t, e).next((t => {
            if (t) {
                const n = t.keys();
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return xi(t).jt({
            ...
            e.userId === this.userId && (U(e.batchId >= n), i = gi(this.k, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatches(t) {
        ...
        return xi(t).Bt(ks.userMutationsIndex, e).next((t => t.map((t => gi(this.k, t)))));
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = xs.prefixForPath(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return $i(t).jt({
            range: s
        }, ((n, s, r) => {
            const [o, c, a] = n, u = Ss(c);
    ...
    getAllMutationBatchesAffectingQuery(t, e) {
        const n = e.path, s = n.length + 1, i = xs.prefixForPath(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    te(t, e) {
        ...
        return e.forEach((e => {
            s.push(xi(t).get(e).next((t => {
                if (null === t) throw B();
                U(t.userId === this.userId), n.push(gi(this.k, t));
            })));
        })), Hs.waitFor(s).next((() => n));
    }
    removeMutationBatch(t, e) {
        return Di(t.Wt, this.userId, e).next((n => (t.addOnCommittedListener((() => {
            this.ee(e.batchId);
        })), Hs.forEach(n, (e => this.referenceDelegate.markPotentiallyOrphaned(t, e))))));
    }
    /**
    ...
    performConsistencyCheck(t) {
        return this.checkEmpty(t).next((e => {
            ...
            // the queue is empty.
                        const n = IDBKeyRange.lowerBound(xs.prefixForUser(this.userId)), s = [];
            return $i(t).jt({
                range: n
            }, ((t, e, n) => {
                if (t[0] === this.userId) {
    ...
    containsKey(t, e) {
        return ki(t, this.userId, e);
    }
    // PORTING NOTE: Multi-tab only (state is held in memory in other clients).
    /** Returns the mutation queue's metadata from IndexedDb. */
    ne(t) {
        return Fi(t).get(this.userId).next((t => t || new Ns(this.userId, -1, 
        /*lastStreamToken=*/ "")));
    }
}
 ...
 */ function ki(t, e, n) {
    const s = xs.prefixForPath(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return $i(t).jt({
        range: r,
        Kt: !0
 ...
 */ function $i(t) {
    return oi(t, xs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Fi(t) {
    return oi(t, Ns.store);
}
 ...
 */ class Mi {
    ...
    getTargetData(t, e) {
        ...
        const n = Yt(e), s = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]);
        let i = null;
        return Li(t).jt({
            range: s,
    ...
    removeMatchingKeysForTargetId(t, e) {
        const n = Ui(t), s = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(s);
    }
    ...
    // PORTING NOTE: Multi-tab only.
    Et(t, e) {
        return Li(t).get(e).next((t => t ? yi(t) : null));
    }
}
 ...
 */ function Li(t) {
    return oi(t, Ls.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function Bi(t) {
    return oi(t, Us.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function Ui(t) {
    return oi(t, Bs.store);
}
 ...
 */ async function qi(t) {
    if (t.code !== j.FAILED_PRECONDITION || t.message !== Gs) throw t;
 ...
 */ class ji {
    constructor(t) {
        this.he = t, this.buffer = new In(Ki), this.le = 0;
    }
    fe() {
        return ++this.le;
    }
 ...
 */ class Qi {
    ...
    me(t) {
        ...
        F("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this._e = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            this._e = null, this.we = !0;
            try {
                await t.collectGarbage(this.garbageCollector);
            } catch (t) {
                ti(t) ? F("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await qi(t);
            }
            await this.me(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Wi {
    ...
    collect(t, e) {
        ...
        Hs.resolve(Vi)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (F("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        Vi) : this.Te(t, e)));
    }
    getCacheSize(t) {
...
class Gi {
     ...
     */    Ae(t, e) {
        return function(t, e) {
            let n = !1;
            return Fi(t).Qt((s => ki(t, s, e).next((t => (t && (n = !0), Hs.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
        ...
        })).next((() => Hs.waitFor(s))).next((() => n.apply(t))).next((() => i));
    }
    removeTarget(t, e) {
 ...
 */ class Ji {
    constructor() {
        ...
        this.changes = new Hi((t => t.toString()), ((t, e) => t.isEqual(e))), this.changesApplied = !1;
    }
    getReadTime(t) {
     ...
     */    removeEntry(t, e = null) {
        this.assertNotApplied(), this.changes.set(t, {
            document: zt.newInvalidDocument(t),
            readTime: e
        });
    }
    /**
     ...
     */    getEntry(t, e) {
        ...
        return void 0 !== n ? Hs.resolve(n.document) : this.getFromCache(t, e);
    }
    /**
 ...
 */ class Yi {
    ...
    ve(t, e, n) {
        if (e.isEmpty()) return Hs.resolve();
    ...
    newChangeBuffer(t) {
        return new Xi(this, !!t && t.trackRemovals);
    }
    getSize(t) {
        return this.getMetadata(t).next((t => t.byteSize));
    }
    getMetadata(t) {
        return Zi(t).get(Ms.key).next((t => (U(!!t), t)));
    }
    Re(t, e) {
        return Zi(t).put(Ms.key, e);
    }
    /**
     ...
     */    Pe(t, e) {
        ...
        return zt.newInvalidDocument(t);
    }
}
...
class Xi extends Ji {
    ...
    constructor(t, e) {
        ...
        this.Ce = new Hi((t => t.toString()), ((t, e) => t.isEqual(e)));
    }
    applyChanges(t) {
        const e = [];
        let n = 0, s = new In(((t, e) => rt(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            const o = this.Ce.get(i);
            if (r.document.isValidDocument()) {
                const c = fi(this.De.k, r.document, this.getReadTime(i));
...
function Zi(t) {
    return oi(t, Ms.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function tr(t) {
    return oi(t, Os.store);
}
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ class nr {
    constructor(t) {
        this.k = t;
    }
    /**
 ...
 */ (t), sr(t), function(t) {
        ...
        0 !== n && (!function(t) {
            t.deleteObjectStore(Bs.store), t.deleteObjectStore(Ls.store), t.deleteObjectStore(Us.store);
        }(t), sr(t)), r = r.next((() => 
        /**
 ...
 */
        function(t) {
            const e = t.store(Us.store), n = new Us(
            /*highestTargetId=*/ 0, 
            /*lastListenSequenceNumber=*/ 0, ut.min().toTimestamp(), 
            /*targetCount=*/ 0);
            return e.put(Us.key, n);
        }
        /**
 ...
 */ (i)))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next((() => function(t, e) {
            return e.store(ks.store).Bt().next((n => {
 ...
 */ (t);
    ...
    Ne(t) {
        const e = t.store(Ns.store), n = t.store(ks.store);
        return e.Bt().next((e => Hs.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.Bt(ks.userMutationsIndex, s).next((n => Hs.forEach(n, (n => {
                U(n.userId === e.userId);
                const s = gi(this.k, n);
     ...
     */    xe(t) {
        const e = t.store(Bs.store), n = t.store(Os.store);
        return t.store(Us.store).get(Us.key).next((t => {
            const s = [];
            return n.jt(((n, i) => {
...
function sr(t) {
    t.createObjectStore(Bs.store, {
        keyPath: Bs.keyPath
    }).createIndex(Bs.documentTargetsIndex, Bs.documentTargetsKeyPath, {
        unique: !0
    });
...
const ir = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";
 ...
 */
        ...
        (this.k, this.Jt), this.Ye = new Ei, this.window && this.window.localStorage ? this.Xe = this.window.localStorage : (this.Xe = null, 
     ...
     */    start() {
        ...
        return this.Ze().then((() => {
            ...
            throw new Q(j.FAILED_PRECONDITION, ir);
     ...
     * primary lease.
     */    Ze() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => cr(t).put(new Ks(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
     ...
     */    on(t) {
        if (this.Le) return Hs.resolve(!0);
        return or(t).get(Cs.key).next((e => {
    ...
    getMutationQueue(t) {
        return Ni.Xt(t, this.k, this.Jt, this.referenceDelegate);
    }
    getTargetCache() {
        return this.He;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.ze.runTransaction(t, s, Ws, (s => (i = new ri(s, this.Be ? this.Be.next() : nt.I), 
    ...
    // be turned off.
    En(t) {
        return or(t).get(Cs.key).next((t => {
            if (null !== t && this.fn(t.leaseTimestampMs, 5e3) && !this._n(t.ownerId) && !this.un(t) && !(this.Le || this.allowTabSynchronization && t.allowTabSynchronization)) throw new Q(j.FAILED_PRECONDITION, ir);
        }));
    }
    /**
     ...
     */    en() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.qe = () => {
            ...
            this.mn(), l() && navigator.appVersion.match(/Version\/1[45]/) && 
 ...
 */
        return function(t) {
            return Ct.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Sn(t, e.path) : Re(e) ? this.Dn(t, e, n) : this.Cn(t, e, n);
    }
    Sn(t, e) {
        // Just do a simple document lookup.
        return this.Rn(t, new Ct(e)).next((t => {
            let e = vn();
    ...
    Dn(t, e, n) {
        ...
        let i = vn();
        return this.Jt.getCollectionParents(t, s).next((r => Hs.forEach(r, (r => {
            const o = function(t, e) {
                return new ge(e, 
    ...
    Cn(t, e, n) {
        ...
        this.Nn(t, i, s).next((t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                ...
                i = zt.newInvalidDocument(n), s = s.insert(n, i)), nn(e, i, t.localWriteTime), i.isFoundDocument() || (s = s.remove(n));
            }
        }))))).next((() => (
 ...
 */ class lr {
 ...
 // do nothing
        ...
        return new lr(t, e.fromCache, n, s);
    }
}
 ...
 */ class fr {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Ln(e, i);
            return (Te(e) || Ee(e)) && this.Bn(e.limitType, r, s, n) ? this.Mn(t, e) : (x() <= c.DEBUG && F("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), De(e)), 
    ...
    Mn(t, e) {
        return x() <= c.DEBUG && F("QueryEngine", "Using full collection scan to execute query:", De(e)), 
...
class dr {
    ...
    t, e, n, s) {
        ...
        this.He = t.getTargetCache(), this.Wn = new hr(this.Qn, this.An, this.persistence.getIndexManager()), 
...
async function _r(t, e) {
    ...
    const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
        ...
        // MutationQueue.
        i = new hr(n.Qn, s, n.persistence.getIndexManager()), s.getAllMutationBatches(t)))).next((e => {
            const n = [], s = [];
 ...
 */ (c, u, e) && o.push(n.He.updateTargetData(t, u));
        ...
        return Hs.waitFor(o).next((() => r.apply(t))).next((() => n.Wn.Vn(t, c))).next((() => c));
    })).then((t => (n.qn = i, t)));
}
...
function Er(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, Hs.resolve(s)) : n.He.allocateTargetId(t).next((i => (s = new ui(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
 ...
 */ function Ar(t, e, n) {
    ...
    })).next((() => s.Un.getDocumentsMatchingQuery(t, e, n ? i : ut.min(), n ? r : Cn()))).next((t => ({
        documents: t,
        zn: r
    })))));
}
...
async function br(t) {
    ...
    return e.persistence.runTransaction("Synchronize last document change read time", "readonly", (t => function(t) {
        ...
        return e.jt({
            ...
            e.readTime && (n = wi(e.readTime)), s.done();
        })).next((() => n));
    }(t))).then((t => {
        e.jn = t;
    }));
...
async function vr(t, e, n, s) {
    ...
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => pr(t, a, o, ut.min(), c).next((e => (a.apply(t), 
 ...
 */ class Sr {
    ...
    getBundleMetadata(t, e) {
        return Hs.resolve(this.Xn.get(e));
    }
    saveBundleMetadata(t, e) {
    ...
    getNamedQuery(t, e) {
        return Hs.resolve(this.Zn.get(e));
    }
    saveNamedQuery(t, e) {
 ...
 */ class Dr {
    constructor() {
        ...
        this.ts = new In(Cr.es), 
        // A set of outstanding references to a document sorted by target id.
        this.ns = new In(Cr.ss);
    }
     ...
     * removed.
     */    us(t) {
        const e = new Ct(new wt([])), n = new Cr(e, t), s = new Cr(e, t + 1), i = [];
    ...
    ls(t) {
        const e = new Ct(new wt([])), n = new Cr(e, t), s = new Cr(e, t + 1);
        let i = Cn();
        return this.ns.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
    ...
    containsKey(t) {
        const e = new Cr(t, 0), n = this.ts.firstAfterOrEqual(e);
...
class Cr {
    ...
    /** Compare by key then by ID */    static es(t, e) {
        return Ct.comparator(t.key, e.key) || rt(t.fs, e.fs);
    }
    /** Compare by ID then by key */    static ss(t, e) {
        return rt(t.fs, e.fs) || Ct.comparator(t.key, e.key);
    }
}
 ...
 */ class Nr {
    constructor(t, e) {
        ...
        this.ws = new In(Cr.es);
    }
    checkEmpty(t) {
        return Hs.resolve(0 === this.An.length);
    }
    addMutationBatch(t, e, n, s) {
        const i = this.ds;
    ...
    lookupMutationBatch(t, e) {
        return Hs.resolve(this._s(e));
    }
    getNextMutationBatchAfterBatchId(t, e) {
        const n = e + 1, s = this.gs(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Hs.resolve(this.An.length > i ? this.An[i] : null);
    }
    getHighestUnacknowledgedBatchId() {
        return Hs.resolve(0 === this.An.length ? -1 : this.ds - 1);
    }
    getAllMutationBatches(t) {
        return Hs.resolve(this.An.slice());
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        const n = new Cr(e, 0), s = new Cr(e, Number.POSITIVE_INFINITY), i = [];
    ...
    getAllMutationBatchesAffectingDocumentKeys(t, e) {
        let n = new In(rt);
        return e.forEach((t => {
            const e = new Cr(t, 0), s = new Cr(t, Number.POSITIVE_INFINITY);
            this.ws.forEachInRange([ e, s ], (t => {
                n = n.add(t.fs);
            }));
        })), Hs.resolve(this.ys(n));
    }
    getAllMutationBatchesAffectingQuery(t, e) {
    ...
    removeMutationBatch(t, e) {
        ...
        return Hs.forEach(e.mutations, (s => {
            const i = new Cr(s.key, e.batchId);
    ...
    containsKey(t, e) {
        const n = new Cr(e, 0), s = this.ws.firstAfterOrEqual(n);
        return Hs.resolve(e.isEqual(s && s.key));
    }
    performConsistencyCheck(t) {
        return this.An.length, Hs.resolve();
    }
    /**
...
class kr {
    ...
    constructor(t, e) {
        ...
        this.docs = new pn(Ct.comparator), 
 ...
 */ class $r {
    ...
    addMatchingKeys(t, e, n) {
        return this.Rs.rs(e, n), Hs.resolve();
    }
    removeMatchingKeys(t, e, n) {
        this.Rs.cs(e, n);
    ...
    removeMatchingKeysForTargetId(t, e) {
        return this.Rs.us(e), Hs.resolve();
    }
    getMatchingKeysForTargetId(t, e) {
    ...
    containsKey(t, e) {
        return Hs.resolve(this.Rs.containsKey(e));
    }
}
...
class Fr {
    ...
    constructor(t, e) {
        ...
        this.Jt = new Ri, this.Je = function(t, e) {
            return new kr(t, e);
        }(this.Jt, (t => this.referenceDelegate.vs(t))), this.k = new hi(e), this.Ye = new Sr(this.k);
    }
    start() {
...
class Mr {
    ...
    addReference(t, e, n) {
        return this.Cs.addReference(n, e), this.xs.delete(n.toString()), Hs.resolve();
    }
    removeReference(t, e, n) {
        return this.Cs.removeReference(n, e), this.xs.add(n.toString()), Hs.resolve();
    }
    markPotentiallyOrphaned(t, e) {
        return this.xs.add(e.toString()), Hs.resolve();
    }
    removeTarget(t, e) {
    ...
    $s(t, e) {
        return Hs.or([ () => Hs.resolve(this.Cs.containsKey(e)), () => this.persistence.getTargetCache().containsKey(t, e), () => this.persistence.Ds(t, e) ]);
    }
}
...
class qr {
     ...
     */    static Fs(t, e, n) {
        ...
        r && (i = new Q(s.error.code, s.error.message))), r ? new qr(t, e, s.state, i) : (O("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Os() {
        const t = {
...
class Kr {
     ...
     */    static Fs(t, e) {
        ...
        i && (s = new Q(n.error.code, n.error.message))), i ? new Kr(t, n.state, s) : (O("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Os() {
        const t = {
 ...
 */ class jr {
     ...
     */    static Fs(t, e) {
        const n = JSON.parse(e);
        let s = "object" == typeof n && n.activeTargetIds instanceof Array, i = kn();
        for (let t = 0; s && t < n.activeTargetIds.length; ++t) s = Dt(n.activeTargetIds[t]), 
        i = i.add(n.activeTargetIds[t]);
        return s ? new jr(t, i) : (O("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Qr {
     ...
     */    static Fs(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Qr(e.clientId, e.onlineState) : (O("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class Gr {
    constructor(t, e, n, s, i) {
        ...
        this.Ks = new pn(rt), this.started = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Qs = Lr(this.persistenceKey, this.Bs), 
        this.Ws = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.Ks = this.Ks.insert(this.Bs, new Wr), this.Gs = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    addLocalQueryTarget(t) {
        ...
        // by another tab
            ...
            const n = this.storage.getItem(Ur(this.persistenceKey, t));
            if (n) {
                const s = Kr.Fs(t, n);
                s && (e = s.state);
            }
    ...
    clearQueryState(t) {
        this.removeItem(Ur(this.persistenceKey, t));
    }
    ...
    qs(t) {
        ...
        if (e.storageArea === this.storage) {
            if (F("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.Qs) return void O("Received WebStorage notification for local change. Another client might have garbage-collected our state");
 ...
 */ (e.newValue);
    ...
    ni(t, e, n) {
        const s = new qr(this.currentUser, t, e, n), i = Br(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.Os());
    }
    si(t) {
        const e = Br(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
    }
    oi(t) {
        const e = {
...
class zr {
    constructor() {
        this.pi = new Wr, this.Ti = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    addPendingMutation(t) {
        // No op.
    }
    ...
    start() {
        return this.pi = new Wr, Promise.resolve();
    }
    handleUserChange(t, e, n) {
        // No op.
    }
...
class {
    ...
    Bi(t, e, n, s, i) {
        ...
        const o = {};
        return this.qi(o, s, i), this.Ki(t, r, o, n).then((t => (F("RestConnection", "Received: ", t), 
        t)), (e => {
            ...
            o.listenOnce(I.COMPLETE, (() => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case A.TIMEOUT:
                        F("Connection", 'RPC "' + t + '" timed out'), r(new Q(j.DEADLINE_EXCEEDED, "Request time out"));
                        break;
 ...
 */
                    function(t) {
                        ...
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        const e = _n[t];
                        if (void 0 !== e) return yn(e);
                    }(t), n = i.message;
                    void 0 === e && (e = j.INTERNAL, n = "Unknown error status: " + t + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    h = !0, l.Fi(new Q(e, n)), a.close();
                } else F("Connection", "WebChannel received:", n), l.Oi(n);
            }
        })), y(r, V.STAT_EVENT, (t => {
            t.stat === S.PROXY ? F("Connection", "Detected buffering proxy") : t.stat === S.NOPROXY && F("Connection", "Detected no buffering proxy");
        })), setTimeout((() => {
...
/** The Platform's 'document' implementation or null if not available. */ function eo() {
...
class so {
     ...
     */    Zi(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && F("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.Hi} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
...
class io {
    constructor(t, e, n, s, i, r, o, c) {
         ...
         * close.
         */
        this.rr = 0, this.cr = null, this.ar = null, this.stream = null, this.ur = new so(t, e);
    }
    /**
     ...
     */    Er(t) {
        return e => {
            this.Oe.enqueueAndForget((() => this.rr === t ? e() : (F("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
 ...
 */ class ro extends io {
     ...
     */    br(t) {
        ...
        e.database = ns(this.k), e.addTarget = function(t, e) {
            ...
            return n = te(s) ? {
                ...
                query: fs(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Gn(t, e.resumeToken) : e.snapshotVersion.compareTo(ut.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = Wn(t, e.snapshotVersion.toTimestamp())), n;
        }(this.k, t);
        const n = ws(this.k, t);
     ...
     */    vr(t) {
        const e = {};
        e.database = ns(this.k), e.removeTarget = t, this.gr(e);
    }
}
 ...
 */ class oo extends io {
    ...
    onMessage(t) {
        ...
        U(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Vr) {
            ...
            this.ur.reset();
            const e = hs(t.writeResults, t.commitTime), n = Hn(t.commitTime);
     ...
     */    kr() {
        ...
        const t = {};
        t.database = ns(this.k), this.gr(t);
    }
...
class ao {
    ...
    qr(t) {
        ...
        this.Lr ? (O(e), this.Lr = !1) : F("OnlineStateTracker", e);
    }
    jr() {
    ...
    e, n, s, i) {
        ...
        this.zr = [], this.Hr = i, this.Hr.Ei((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                po(this) && (F("RemoteStore", "Restarting streams for network reachability change."), 
                await async function(t) {
                    const e = K(t);
                    e.Gr.add(4 /* ConnectivityChange */), await lo(e), e.Jr.set("Unknown" /* Unknown */), 
...
async function ho(t) {
    if (po(t)) for (const e of t.zr) await e(/* enabled= */ !0);
}
 ...
 */ function wo(t, e) {
    const n = K(t), s = Fo(n);
    n.Wr.delete(e), s.lr() && mo(n, e), 0 === n.Wr.size && (s.lr() ? s._r() : po(n) && 
 ...
 */ function yo(t) {
    return po(t) && !Fo(t).hr() && t.Wr.size > 0;
}
 ...
 */ (t, e);
        ...
        await Ro(t, n);
    } else if (e instanceof Fn ? t.Yr.ot(e) : e instanceof On ? t.Yr.dt(e) : t.Yr.ut(e), 
    !n.isEqual(ut.min())) try {
        const e = await gr(t.localStore);
        n.compareTo(e) >= 0 && 
 ...
 */
        function(t, e) {
            ...
            n.targetMismatches.forEach((e => {
                ...
                const s = new ui(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                _o(t, s);
            })), t.remoteSyncer.applyRemoteEvent(n);
        }(t, n);
    } catch (e) {
        F("RemoteStore", "Failed to raise snapshot:", e), await Ro(t, e);
    }
}
 ...
 */ async function Ro(t, e, n) {
    ...
    await lo(t), t.Jr.set("Offline" /* Offline */), n || (
    ...
    t.asyncQueue.enqueueRetryable((async () => {
        F("RemoteStore", "Retrying IndexedDB access"), await n(), t.Gr.delete(1 /* IndexedDbFailed */), 
        await ho(t);
    }));
}
...
async function bo(t) {
    ...
    for (;vo(e); ) try {
        const t = await Tr(e.localStore, s);
        if (null === t) {
            0 === e.Qr.length && n._r();
            break;
        }
...
function So(t) {
    return po(t) && !Oo(t).hr() && t.Qr.length > 0;
}
...
async function $o(t, e) {
    const n = K(t);
    e ? (n.Gr.delete(2 /* IsSecondary */), await ho(n)) : e || (n.Gr.add(2 /* IsSecondary */), 
    await lo(n), n.Jr.set("Unknown" /* Unknown */));
}
 ...
 */ function Fo(t) {
    ...
    t.Xr = function(t, e, n) {
        const s = K(t);
        return s.Fr(), new ro(e, s.ir, s.authCredentials, s.appCheckCredentials, s.k, n);
    }
    /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ function Oo(t) {
    ...
    t.Zr = function(t, e, n) {
        const s = K(t);
        return s.Fr(), new oo(e, s.ir, s.authCredentials, s.appCheckCredentials, s.k, n);
    }(t.datastore, t.asyncQueue, {
        Di: Co.bind(null, t),
        Ni: xo.bind(null, t),
        Nr: No.bind(null, t),
 ...
 */ function Lo(t, e) {
    if (O("AsyncQueue", `${e}: ${t}`), ti(t)) return new Q(j.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class Bo {
    ...
    constructor(t) {
        ...
        this.keyedMap = vn(), this.sortedSet = new pn(this.comparator);
    }
    /**
...
class jo {
    constructor() {
        this.queries = new Hi((t => Se(t)), Ve), this.onlineState = "Unknown" /* Unknown */ , 
        this.io = new Set;
    }
}
...
async function Qo(t, e) {
    ...
    if (r || (i = !0, r = new Ko), i) try {
        ...
        const n = Lo(t, `Initialization of query '${De(e.query)}' failed`);
 ...
 */ class Xo {
     ...
     */    Jn(t) {
        return t.metadata.exists ? rs(this.k, t.document, !1) : zt.newNoDocument(this.Hn(t.metadata.name), this.Yn(t.metadata.readTime));
    }
    Yn(t) {
        return Hn(t);
    }
 ...
 */ class Zo {
     ...
     */    async complete() {
        const t = await vr(this.localStore, new Xo(this.k), this.documents, this.mo.id), e = this.po(this.documents);
        for (const t of this.queries) await Vr(this.localStore, t, e.get(t.name));
        return this.progress.taskState = "Success", new ur(Object.assign({}, this.progress), t);
    }
}
 ...
 */ class sc {
    ...
    e) {
        ...
        this.mutatedKeys = Cn(), this.Ao = Ne(t), this.Ro = new Bo(this.Ao);
    }
    /**
     ...
     */    bo(t, e) {
        ...
        const c = Te(this.query) && s.size === this.query.limit ? s.last() : null, a = Ee(this.query) && s.size === this.query.limit ? s.first() : null;
        ...
        })), Te(this.query) || Ee(this.query)) for (;r.size > this.query.limit; ) {
            const t = Te(this.query) ? r.last() : r.first();
 ...
 */ class oc {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.Fo = {}, this.Oo = new Hi((t => Se(t)), Ve), 
        this.Mo = new Map, 
        /**
         ...
         * active target.
         */
        this.Bo = new pn(Ct.comparator), 
        /**
         * Keeps track of the information about an active limbo resolution for each
         * active target ID that was started for the purpose of limbo resolution.
         */
        this.Uo = new Map, this.qo = new Dr, 
...
/** Stops listening to the query. */ async function uc(t, e) {
    ...
    } else pc(n, s.targetId), await Ir(n.localStore, s.targetId, 
 ...
 */ async function hc(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = K(t), s = at.now(), i = e.reduce(((t, e) => t.add(e.key)), Cn());
            let r;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Wn.vn(t, i).next((i => {
                ...
                const o = [];
                for (const t of e) {
                    const e = sn(t, r.get(t.key));
                    null != e && 
                    // NOTE: The base state should only be applied if there's some
                    // existing document to override, so use a Precondition of
                    // exists=true
                    o.push(new an(t.key, e, Gt(e.value.mapValue), Xe.exists(!0)));
                }
 ...
 */ async function dc(t, e, n) {
    ...
    if (r) {
        ...
        let t = new pn(Ct.comparator);
        t = t.insert(r, zt.newNoDocument(r, ut.min()));
    ...
    /* keepPersistedTargetData */ !1).then((() => pc(s, e, n))).catch(qi);
}
...
function Tc(t, e) {
    ...
    const n = t.Bo.get(e);
    null !== n && (wo(t.remoteStore, n), t.Bo = t.Bo.remove(e), t.Uo.delete(n), Ac(t));
}
...
async function Dc(t, e) {
    ...
    if (Fc(n), Oc(n), !0 === e && !0 !== n.Wo) {
        ...
        function(t) {
            ...
            e.Uo.forEach(((t, n) => {
                wo(e.remoteStore, n);
            })), e.qo.hs(), e.Uo = new Map, e.Bo = new pn(Ct.comparator);
        }
        /**
...
async function Cc(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await Er(s.localStore, n), await ac(s, Nc(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
async function xc(t, e, n, s) {
    ...
    F("SyncEngine", "Ignoring unexpected query state notification."); else if (i.Mo.has(e)) switch (n) {
      case "current":
      case "not-current":
        {
...
class Lc {
    ...
    async initialize(t) {
        this.k = no(t.databaseInfo.databaseId), this.sharedClientState = this.Jo(t), this.persistence = this.Yo(t), 
    ...
    Zo(t) {
        return wr(this.persistence, new fr, t.initialUser, this.k);
    }
    Yo(t) {
        return new Fr(Mr.ks, this.k);
    }
    Jo(t) {
        return new zr;
    }
 ...
 */ class Bc extends Lc {
    ...
    Yo(t) {
        const e = ar(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? Si.withCacheSize(this.cacheSizeBytes) : Si.DEFAULT;
 ...
 */ class qc {
    ...
    terminate() {
        return async function(t) {
            const e = K(t);
            F("RemoteStore", "RemoteStore shutting down."), e.Gr.add(5 /* Shutdown */), await lo(e), 
            e.Hr.shutdown(), 
...
class Wc {
    ...
    delete(t) {
        this.write(new fn(t, this.precondition(t))), this.writtenDocs.add(t.toString());
    }
    async commit() {
...
class Gc {
    constructor(t, e, n, s) {
        ...
        this.lc = 5, this.ur = new so(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    ...
    _c(t) {
        if ("FirebaseError" === t.name) {
            ...
            const e = t.code;
            return "aborted" === e || "failed-precondition" === e || !gn(e);
        }
        return !1;
    }
}
...
async function Hc(t, e) {
    ...
    t.setCredentialChangeListener((async t => {
        s.isEqual(t) || (await _r(e.localStore, t), s = t);
    })), 
...
async function Jc(t, e) {
    ...
    t.setCredentialChangeListener((t => async function(t, e) {
        ...
        // new mutations from the LocalStore (since mutations are per-user).
                n.Gr.add(3 /* CredentialChange */), await lo(n), s && 
        // Don't set the network status to Unknown if we are offline.
        n.Jr.set("Unknown" /* Unknown */), await n.remoteSyncer.handleCredentialChange(e), 
        n.Gr.delete(3 /* CredentialChange */), await ho(n);
 ...
 */
        return function(t) {
            const e = ma.get(t);
            e && (F("ComponentProvider", "Removing Datastore"), ma.delete(t), e.terminate());
...
function Na(t, e, ...n) {
    ...
    }
    {
        if (!(t instanceof va || t instanceof Sa)) throw new Q(j.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(wt.fromString(e, ...n));
        return pa(s), new va(t.firestore, t instanceof Sa ? t.converter : null, new Ct(s));
    }
}
 ...
 * Firestore database.
 */ function ka(t, e) {
    return t = p(t), e = p(e), (t instanceof va || t instanceof Sa) && (e instanceof va || e instanceof Sa) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function xa(t, e) {
    return t = p(t), e = p(e), t instanceof Va && e instanceof Va && (t.firestore === e.firestore && Ve(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ class su {
     ...
     */    static fromBase64String(t) {
        try {
            return new su(Tt.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new su(Tt.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class cu {
    ...
    toMutation(t, e) {
        return null !== this.fieldMask ? new an(t, this.data, this.fieldMask, e, this.fieldTransforms) : new cn(t, this.data, e, this.fieldTransforms);
    }
}
...
function fu(t) {
    const e = t._freezeSettings(), n = no(t._databaseId);
...
class gu extends iu {
    ...
    _toFieldTransform(t) {
        const e = _u(this, t, 
        /*array=*/ !0), n = this.Wc.map((t => Au(t, e))), s = new qe(n);
...
class yu extends iu {
    ...
    _toFieldTransform(t) {
        const e = _u(this, t, 
        /*array=*/ !0), n = this.Wc.map((t => Au(t, e))), s = new je(n);
        return new He(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class pu extends iu {
    ...
    _toFieldTransform(t) {
        const e = new We(t.k, Fe(t.k, this.Gc));
 ...
 */ function vu(t, e, n) {
    ...
    // FieldPath.
    e = p(e)) instanceof eu) return e._internalPath;
    if ("string" == typeof e) return Su(t, e);
    throw Du("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 */ class Mu {
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new Ou(this._firestore, this._userDataWriter, n.key, n, new $u(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => ({
                    type: "added",
                    doc: new Ou(t._firestore, t._userDataWriter, n.doc.key, n.doc, new $u(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache), t.query.converter),
                    oldIndex: -1,
                    newIndex: e++
                })));
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new Ou(t._firestore, t._userDataWriter, e.doc.key, e.doc, new $u(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
 ...
 * limitations under the License.
 */ function Uu(t) {
    if (Ee(t) && 0 === t.explicitOrderBy.length) throw new Q(j.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class zu extends qu {
    ...
    _apply(t) {
        return new Va(t.firestore, t.converter, ve(t._query, this.Xc, this.Zc));
    }
}
...
/** Helper function to create a bound from a document or fields */ function sh(t, e, n, s) {
    if (n[0] = p(n[0]), n[0] instanceof Nu) return function(t, e, n, s, i) {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    ...
                    if (!Re(t) && -1 !== a.indexOf("/")) throw new Q(j.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
...
function ih(t, e, n) {
    if ("string" == typeof (n = p(n))) {
        ...
        if (!Re(e) && -1 !== n.indexOf("/")) throw new Q(j.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
    ...
    if (n instanceof va) return Lt(t, n._key);
    throw new Q(j.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${Ea(n)}.`);
}
 ...
 */ class ch {
    ...
    convertGeoPoint(t) {
        return new ru(At(t.latitude), At(t.longitude));
    }
    convertArray(t, e) {
 ...
 */ class hh {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = p(e)) || e instanceof eu ? Eu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : Tu(this._dataReader, "WriteBatch.update", i._key, e), 
        this._mutations.push(r.toMutation(i._key, Xe.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        ...
        return this._mutations = this._mutations.concat(new fn(e._key, Xe.none())), this;
    }
    /**
 ...
 */ function wh(t) {
    ...
    return oa(n, t._key).then((n => new Fu(e, s, t._key, n, new $u(null !== n && n.hasLocalMutations, 
 ...
 */ function mh(t) {
    t = Ia(t, Va);
    const e = Ia(t.firestore, La), n = qa(e), s = new dh(e);
    return Uu(t._query), ua(n, t._query).then((n => new Mu(e, s, t, n)));
}
 ...
 */ function gh(t) {
    t = Ia(t, Va);
    const e = Ia(t.firestore, La), n = qa(e), s = new dh(e);
    return aa(n, t._query).then((n => new Mu(e, s, t, n)));
}
 ...
 */ class vh extends class {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = p(e)) || e instanceof eu ? Eu(this._dataReader, "Transaction.update", i._key, e, n, s) : Tu(this._dataReader, "Transaction.update", i._key, e), 
     ...
     */    get(t) {
        ...
        return super.get(t).then((t => new Fu(this._firestore, n, e._key, t._document, new $u(
        /* hasPendingWrites= */ !1, 
