...
/**
 * @vue/test-utils v2.0.0-rc.17
 * (c) 2021 Lachlan Miller
 * Released under the MIT License
 */

import * as vue from 'vue';
import { nextTick, transformVNodeArgs, Transition, defineComponent, TransitionGroup, Teleport, h, setDevtoolsHook, reactive, createApp } from 'vue';
...
function find(root, selector) {
    ...
    return matchingVNodes.map(function (vnode) { return vnode.component.proxy; });
}

var DOMWrapper = /** @class */ (function (_super) {
    __extends(DOMWrapper, _super);
    function DOMWrapper(element, createVueWrapper) {
        var _this = _super.call(this, element) || this;
        _this.createVueWrapper = createVueWrapper;
        // plugins hook
    ...
    DOMWrapper.prototype.findAll = function (selector) {
        var _this = this;
        return Array.from(this.element.querySelectorAll(selector)).map(function (x) { return new DOMWrapper(x, _this.createVueWrapper); });
    };
    DOMWrapper.prototype.findComponent = function (selector) {
        ...
        if (typeof selector === 'object' && 'ref' in selector) {
            ...
            if (result_1 && !(result_1 instanceof HTMLElement)) {
                return this.createVueWrapper(null, result_1);
            }
            else {
                return createWrapperError('VueWrapper');
            }
    ...
    DOMWrapper.prototype.findAllComponents = function (selector) {
        ...
        return find(parentComponent.subTree, selector)
            ...
            .map(function (c) { return _this.createVueWrapper(null, c); });
    };
    ...
    DOMWrapper.prototype.setSelected = function () {
        ...
        return new DOMWrapper(parentElement, this.createVueWrapper).trigger('change');
    };
    return DOMWrapper;
}(BaseWrapper));
    ...
    VueWrapper.prototype.findAll = function (selector) {
        var results = this.parentElement['__vue_app__']
            ...
            : this.element.querySelectorAll
                ...
                : [];
        return Array.from(results).map(function (element) { return new DOMWrapper(element, createWrapper); });
    };
    VueWrapper.prototype.isVisible = function () {
        var domWrapper = new DOMWrapper(this.element, createWrapper);
...
function mount(inputComponent, options) {
    ...
    var wrapper = createWrapper(app, appRef, setProps);
